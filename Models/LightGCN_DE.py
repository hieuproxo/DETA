...
class LightGCN_DE(LightGCN):
    def __init__(self, user_count, item_count, teacher_user_emb, teacher_item_emb, student_dim, num_layers, Graph, num_experts, gpu):
        """
        Parameters
        ----------
        ...
        # build user/item selection networks
...
class LightGCN_DETA(LightGCN):
    def __init__(self, user_count, item_count, teacher_user_emb, teacher_item_emb, TA_user_emb_list, TA_item_emb_list, student_dim, num_layers, Graph, num_experts, gpu):
        """
        Parameters
        ----------
        user_count (int): number of users
        ...
        for TA_user_emb, TA_item_emb in zip(self.user_emb_TAs, self.item_emb_TAs): 
            TA_user_emb.weight.requires_grad = False
            TA_item_emb.weight.requires_grad = False
