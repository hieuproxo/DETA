...
def print_final_result(eval_dict):
	...
	for mode in ['valid', 'test']:
		...
		r_dict = {'H05':0, 'N05':0, 'H10':0, 'N10':0, 'H15':0, 'N15':0, 'H20':0, 'N20':0}
...
def LOO_latent_factor_evaluate(model, test_dataset):
	"""
	Leave-one-out evaluation for latent factor model (BPR, LightGCN)
	----------
	...
	metrics = {'H05':[], 'N05':[], 'H10':[], 'N10':[], 'H15':[], 'N15':[], 'H20':[], 'N20':[]}
